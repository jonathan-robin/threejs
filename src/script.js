...
pointLight2.position.set(1.99,-1.53,-1.37)
pointLight2.intensity = 5.68
...
//Light2
const pointLight3 = new THREE.PointLight(0xb7bff, 2)
pointLight3.position.set(-1.71,2.39,-1.98)
pointLight3.intensity = 5.68
